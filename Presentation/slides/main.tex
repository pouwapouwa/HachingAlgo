...
\begin{frame}[fragile]
  ...
  \begin{itemize}
        \item{\textbf{Théorème:} Si la fonction de compression $h$ utilisée par la fonction de hachage $H$ l'est aussi.} 
  \end{itemize}
  \vfill
\end{frame}
...
\item{Des attaques génériques de Merkle-Damg\r{a}rd existent. }
\end{itemize}
  \vfill
\end{frame}
